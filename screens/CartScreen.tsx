      ...
      <View style={styles.content}>
        ...
        <View style={{flexDirection:"row", alignItems:"center"}}>
          ...
          <View style = {{flexDirection:"row", marginLeft:20,justifyContent:"center",alignItems:"center"}}>
            ...
            <Text style={{backgroundColor:'#d6ecdf',width:30, textAlign:'center'}}>2</Text>
            <Feather name="plus-square" size={20} color ='#4CAD73'/>
          </View>
          <Text style={{alignSelf:"flex-end", fontWeight:"bold", fontSize:13, marginLeft:-60,marginBottom:10}}>$1.98</Text>
        </View>

        <View style={{flexDirection:"row", alignItems:"center"}}>
        <View style={styles.shadow}>
          <View style={styles.item}>
            <Image style = {styles.item_pic} source={require("../assets/images/spinach.jpeg")}/>
            <View style={styles.name_price_tag}>
              <Text style={styles.item_name}>Spinach</Text>
              <View style={{flexDirection:'row'}}>
                <Text style={styles.price}>$3.99</Text><Text style={styles.unit}> / lb</Text>
              </View>
            </View>
          </View>
          ...
          <View style = {{flexDirection:"row", marginLeft:20,justifyContent:"center",alignItems:"center"}}>
            <Feather name="minus-square" size={20} color="#4CAD73"/>
            <Text style={{backgroundColor:'#d6ecdf',width:30, textAlign:'center'}}>4</Text>
            <Feather name="plus-square" size={20} color ='#4CAD73'/>
          </View>
        <Text style={{alignSelf:"flex-end", fontWeight:"bold", fontSize:13, marginLeft:-60, marginBottom:10}}>$15.96</Text>
        </View>
        ...
        <View style={[styles.row, {padding: 10, justifyContent: 'flex-start'}]}>
          ...
          <Text style={{fontSize: 20, flex: 1, paddingLeft: 20, alignSelf: 'center', color: '#085B26'}}>Rebekah</Text>
          <View style={styles.buyStatus}>
            <Text style={{color: '#4Cad73', fontWeight: 'bold', fontSize: 14}}>
              Completed
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.row, {padding: 10, justifyContent: 'space-between'}]}>
          ...
          <Text style={{fontSize: 20, flex: 1, paddingLeft: 20, alignSelf: 'center', color: '#085B26'}}>Jerry</Text>
        ...
        <View style={{flex: 1, justifyContent: "center", alignItems: "center"}}>
          <Text style={styles.shoppingStatus}>
            Shopping completed: 1/3
          </Text>
          <Text style={styles.shoppingStatus}>
            Add <Text style={{color:"red", fontSize:20}}>$5</Text> more to get more discount
          </Text>
        </View>
